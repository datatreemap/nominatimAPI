...
import nominatim.attractions.POI;
import nominatim.attractions.NominatimPOI;

public class Test {  
 public static String [] attractions = {"bar", "cafe", "pub", "restaurant", "theatre",  "museum", "cinema"};   
 public static String[] piemonte = {"7.3389,44.8383,8.3496,45.1917"};   
 
 
 public static void main (String [] args) throws Exception{  
	 NominatimPOI nominatim = new NominatimPOI();   
	 ...
	 for(int c = 0; c < piemonte.length; c++){  
		 ...
		 for(int i = 0; i < attractions.length; i++){  
			 ...
			 POI result =  nominatim.getAttractions(lat1,lon1,lat2,lon2, attractions[i]);           //returns Address object for the given position  
